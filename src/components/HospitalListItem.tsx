...
const HospitalListItem: React.FC<ButtonProps> = ({ onTap, id, address, description, tint = COLORS.fade, color = COLORS.dark, backgroundColor = 'transparent', }) => {
        ...
        <Pressable onPress={onTap ? () => onTap(id) : () => { }} style={({ pressed }) => ({
            ...
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'flex-start', marginBottom: 8, alignItems: 'flex-start' }}>
                ...
                <View style={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center' }}>
                    <Text style={{ fontSize: 16, flexShrink: 1, textAlign: 'left', overflow:'hidden', paddingRight: 8, fontFamily: FONTS.medium, color: COLORS.gray}}>{description}</Text>
                </View>
            </View>
